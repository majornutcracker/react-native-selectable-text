  ...
  rangy.createModule(
    ...
    function (api, module) {
      ...
      if (
        ...
        typeof decodeURIComponent == UNDEF
      ) {
        module.fail(
          "encodeURIComponent and/or decodeURIComponent method is missing"
        );
      }
      ...
      function serializeRange(range, omitChecksum, rootNode) {
        rootNode =
          rootNode || api.DomRange.getRangeDocument(range).documentElement;
      ...
      function serializeSelection(selection, omitChecksum, rootNode) {
        ...
        for (var i = 0, len = ranges.length; i < len; ++i) {
          serializedRanges[i] = serializeRange(
            ranges[i],
            omitChecksum,
            rootNode
          );
      ...
      function saveSelectionCookie(win, props) {
        ...
        var expires = props.expires
          ? ";expires=" + props.expires.toUTCString()
          : "";
